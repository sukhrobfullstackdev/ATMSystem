    ...
    public ResponseEntity<Message> addUser(UserDTO userDto) {
        if (!authenticationRepository.existsByUsername(userDto.getEmail())) {
            ...
            if (optionalRole.isPresent()) {
                authenticationRepository.save(new User(userDto.getFirstName(), userDto.getLastName(), userDto.getEmail(), passwordEncoder.encode(userDto.getPassword()), userDto.getSalary(), optionalRole.get(), true));
